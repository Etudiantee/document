...
import '../PNT/feuille.css';
import AdminPNT from './AdminPNT';
import { Link } from 'react-router-dom/dist';
function Updatefeuille() {
  ...
  return (
    <div className='bo2'>
       <Link to="/AdminPNT" className="btn btn-primary btn-xs">Home</Link>
      <div className="App">
        <div className="container-fluid mt-5 pt-4">
          ...
          <input hidden type="text" name="dayOfOrigin" className="t1 date-input" value={dayOfOrigin} onChange={(e) => setDayOfOrigin(e.target.value)} />
          <input hidden type="text" name="TLC" className="t1 text-input" value={TLC} onChange={(e) => setTLC(e.target.value)} />
